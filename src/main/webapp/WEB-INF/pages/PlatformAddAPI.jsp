...
<div class="wrap-fluid">
    <div class="container-fluid paper-wrap bevel tlbr">
        ...
        <ul id="breadcrumb">
            ...
            <li><a href="#" title="Sample page 1">ADD API</a>
            </li>
            <li class="pull-right">
                            ...
                            <div class="form_center">
                                <form role="form" class="form-horizontal" >
                                    <div class="form-group">
                                        <label class="col-lg-2 col-sm-2 control-label" for="APIAPPName">应用名：</label>
                                        <div class="col-lg-10">
                                                <select name="app" id="APIAPPName" onchange="selectAPP(this.options[this.options.selectedIndex].value)">
                                                    <c:forEach var="appName" items="${appNameList}" varStatus="state">
                                                        <tr>
                                            ...
                                            <p class="help-block">选择添加接口的应用。</p>
                                        </div>
                                    </div>
                                    <div class="form-group" id="getAPPIDDiv" style="display: none">
                                        <label class="col-lg-2 col-sm-2 control-label" for="ShowAPPID">APPID:</label>
                                        <div class="col-lg-10">
                                            <input type="text" id="ShowAPPID" class="form-control">
                                        </div>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="body-nest" id="element">
                            ...
                            <div class="panel-body">
                                <form method="get" id="completeAPP" name="appForm"  class="form-horizontal bucket-form">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">DataAddr:</label>
                                        <div class="col-sm-6">
                                            <input type="text" id="DataAddr" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" id="method" value="POST/GET/..." class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-offset-2 col-lg-10">
                                            ...
                                            <button class="btn btn-default" type="button" onclick="completeAPIData()" >开始监听</button>
...
<script type="text/javascript" src="assets/AddAPI.js"></script>
